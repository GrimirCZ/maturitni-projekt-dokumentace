...
\begin{document}
	...
	\input{text-08-provoz-aplikace}
	
	\input{text-09-bezpecnost}
	
	\input{text-10-zaver}
	
	\chapter*{Seznamy}
	\addcontentsline{toc}{chapter}{Seznamy}
	...
	\printglossaries
	\addcontentsline{toc}{section}{Slovník}
