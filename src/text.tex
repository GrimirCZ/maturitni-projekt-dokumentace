...
\sloppy
  ...
  Dále bych chtěl poděkovat panu Jiřímu Formánkovy za poskytnutí myšlenky projektu, podnětů a propagace projektu.\
  \par \
  ...
  \tableofcontents % vysází obsah
	...
	%%% Fungování burz škol
	\input{text-02-serverova-architektura}
	
	\input{text-03-aplikacni-architektura}

	\input{text-04-vyvojova-prostredi}
	
	\chapter{Realizace projektu}
	\label{chap:practical-part}
	
	\input{text-05-navrh-datoveho-modelu}
	
	\input{text-06-vyvoj-projektu}
	
	\input{text-07-nasazeni-projektu}
	
	\input{text-08-bezpecnost}
	
	\input{text-09-provoz-aplikace}
